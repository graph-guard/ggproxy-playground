const r=0,t="Starwars",n=`# The query type, represents all of the entry points into our object graph
type Query {
...
scalar Time
`,e=[{_version:0,name:"Hero & reviews",source:`query {
	hero(episode: JEDI) {
		id
		appearsIn
	}
...
}`}],i={_version:0,name:t,schema:n,templates:e};export{r as _version,i as default,t as name,n as schema,e as templates};
